...
$api_repo= array();
$api_repo["INVOICE_ACTION_SAVE"]="http://172.16.47.54:8081/public/email/campaign/item/action/save";

if(isset($_GET['accesscode']) && $_GET['accesscode']!=''){	
	$api_repo["INVOICE_ACCESS"]=sprintf("http://172.16.47.54:8081/public/email/campaign/item/preview/access/%s?recipientEmailId=%s@gmail.com"
