define(['angularAMD', 'utilService', 'fieldService', 'gridService'], function (angularAMD) {
    ...
    angularAMD.controller('addressFieldController', function ($scope, $injector, $http, $location, $controller, httpService, overlay, Notification, $filter,
        $templateCache, utilService, fieldService, gridService) {
        var self = this;

        var fieldConfigUrl = "apps/commonconfig/addressConfig.json";
