...
$api_repo= array();
$api_repo["INVOICE_ACTION_SAVE"]="http://apps.chrims.com:8180/public/email/campaign/item/action/save";

if(isset($_GET['accesscode']) && $_GET['accesscode']!=''){	
	$api_repo["INVOICE_ACCESS"]=sprintf("http://apps.chrims.com:8180/public/email/campaign/item/preview/access/%s?recipientEmailId=%s@gmail.com"
