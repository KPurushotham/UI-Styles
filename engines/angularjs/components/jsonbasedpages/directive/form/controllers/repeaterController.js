define(['angularAMD', 'modelUtilService', 
        'dateUtilService', 'fieldService', 'fieldBaseController', 
        'dateRangeFieldController', 'utilService'], function (angularAMD) {
    'use strict';

    angularAMD.controller('repeaterController', function ($scope, $controller, httpService, overlay,
        ...
        var init = function () {
            ...
            $scope.compositeFieldCount = $scope.field["rfields"].length;
