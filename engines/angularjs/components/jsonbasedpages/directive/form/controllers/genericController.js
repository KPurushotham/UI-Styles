define(['angularAMD', 'modelUtilService', 'dateUtilService', 'fieldService', 'angularjs-gauge', 'modalPopUpService'], function (angularAMD) {
    ...
    angularAMD.controller('genericController', function ($scope, $controller, httpService, overlay, Notification,
        ...
        $scope.field.setModel = function (data) {
            $scope.field.auditData = data;
           // $scope.field.auditData.title = $scope.field.title;
