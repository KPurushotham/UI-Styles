define(['angularAMD', 'utilService', 'dateUtilService', 'fieldService', 'fieldBaseController', 'multiCalendarController', 'utilService'], function (angularAMD) {
    'use strict';

    angularAMD.controller('multiCalendarController', function ($scope, $controller, httpService, overlay, Notification, $filter, utilService, dateUtilService, fieldService) {
