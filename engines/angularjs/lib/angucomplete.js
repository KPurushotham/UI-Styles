...
/*! Copyright (c) 2014 Hidenari Nozaki and contributors | Licensed under the MIT license */
  ...
  angular.module('angucomplete-alt', []).directive('angucompleteAlt', ['$q', '$parse', '$http', '$sce', '$timeout', '$templateCache','httpService', '$interpolate', function ($q, $parse, $http, $sce, $timeout, $templateCache, httpService,$interpolate) {
    // keyboard events
    var KEY_DW  = 40;
    var KEY_RT  = 39;
    var KEY_UP  = 38;
