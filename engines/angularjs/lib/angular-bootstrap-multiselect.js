define(['angularAMD'], function (angularAMD) {
    ...
    multiselect.directive('multiselect', ['$filter', '$document', '$log', function ($filter, $document, $log) {
        return {
            ...
            require: 'ngModel',
            templateUrl: 'engines/angularjs/lib/mutliselect/multiselect.html',
            ...
            link: function ($scope, $element, $attrs, $ngModelCtrl) {
                ...
                // if (typeof $scope.isLoaded == 'undefined') {
                ...
                $scope.getLoadingtext = function () {
                    console.log("*** isLoaded=",$scope.isLoaded);//.isLoaded());
                   // console.log("*** getLoadingtext=", $scope.isLoaded());
                ...
                $scope.getButtonText = function () {
                    ...
                    if ($scope.selectedOptions && $scope.selectedOptions.length > 1) {
                        //var selectedItems = _.map($scope.selectedOptions, function (item) { return item.text; });

                        //return $scope.getDisplay(selectedItems.join(", "));
                ...
                $scope.selectAllHandler = function (options, reset) {
                    if (!reset) {
                        $scope.options = options;
                        $scope.resolvedOptions = options;
                        $scope.selectAll();
                    }
                    else {
                        $scope.unselectAll();
                ...
                $scope.selectAll = function () {
                  //  $scope.selectedOptions = $scope.resolvedOptions.slice(); // Take a copy;
                    $scope.selectedOptions = $scope.resolvedOptions ? $scope.resolvedOptions.slice() : []; // Take a copy;
                ...
                $scope.unselectAll = function () {
                    $scope.selectedOptions = [];
                    //$scope.unselectedOptions = $scope.resolvedOptions.slice(); // Take a copy;
                    $scope.unselectedOptions = $scope.resolvedOptions ? $scope.resolvedOptions.slice() : [] ; // Take a copy;
                };
